...
export const Points = () => {
  ...
  useEffect(() => {
    const loadPosition = async () => {
      ...
      if (status !== 'granted') {
        Alert.alert('Ops..', 'Needs permition to get location')
        return
      }
  ...
  const handleNavigationDetail = (id: number) => navigation.navigate('Detail', {point_id: id})
    ...
    <>
      <View style={styles.container}>
        ...
        <View style={styles.mapContainer}>
          {initialPosition[0] !== 0 && (
            <MapView loadingEnabled={initialPosition[0] === 0} style={styles.map} initialRegion={{
